...
export default function Footer() {
    return <>
        <div className="text-center py-10 shadow-inner bg-purple-100">
            ...
            <span className="block text-sm text-center text-gray-500">© 2021-2022 Landwind™. All Rights Reserved.
                ...
                <Link to={"https://flowbite.com"}
                    className="text-purple-600 hover:underline">Flowbite</Link> and
                <Link
                    to={"https://tailwindcss.com"} className="text-purple-600 hover:underline">Tailwind
                    CSS
                </Link>.
            </span>
